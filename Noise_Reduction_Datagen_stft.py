...
class Signal_Synthesis_DataGen(Dataset):
    def __init__(self, noise_dir, noise_metadata, signal_dir, signal_metadata, num_samples=200, signal_path_save=None, noise_path_save=None,                  n_fft=400, win_length=400, hop_len=200, f_min=0, f_max=8000,                  perform_stft=True, normalize=True, default_sr=16000, sec=6, augment=False):
